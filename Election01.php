...
<!-- Start Header -->
 ...
 <div class="text  rows">
<form class="signupEl" method="POST" action="">
 <div >
  <h4> انتخب الامين العام للاتحاد</h4>
  ...
  <input type="text" name="Whatyourchoicecandidate" >
...
<?php 
  ...
  if(isset($_POST['Whatyourchoicecandidate'])){
    $chcand = $_POST['Whatyourchoicecandidate'];
  }
  ...
  if ($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(isset($_POST['add'])){
       $query = "INSERT INTO secretarygeneral (canid,cannam,stuid,Whatyourchoicecandidate,electiondate)
             VALUE ('$cid','$cnam','$stid','$chcand','$edte')";
       mysqli_query($conn , $query);
       echo  "<center style='color:#000; font-size:25px; margin: 30px;'>" . "تم  الانتخاب " . "</center>" ;
     } 
